...
- [dev](https://github.com/miaowmiaow/fragmject/tree/dev) 分支需最新预览版本 `Android Studio Jellyfish | 2023.3.1 Canary 12` 及以上版本运行(可能需要梯子)。 [Download Android Studio | Android Developer](https://developer.android.google.cn/studio/preview?hl=en)

...
import com.example.fragmject.feature.demo.components.calendar.Calendar
import com.example.fragmject.feature.demo.components.calendar.rememberCalendarState
        ...
        if (openDialog) {
            Dialog(onDismissRequest = { openDialog = false }) {
                Card(
                    ...
                    colors = CardColors(
                        containerColor = AppColors.theme,
                        contentColor = AppColors.theme,
                        disabledContainerColor = AppColors.orange,
                        disabledContentColor = AppColors.orange,
                    )
                ) {
                    Column(

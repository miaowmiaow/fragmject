    ...
    Box(contentAlignment = Alignment.BottomEnd) {
        ...
        if (openDialog) {
            Dialog(onDismissRequest = { openDialog = false }) {
                Card(
                    ...
                    colors = CardColors(
                        containerColor = WanColors.theme,
                        contentColor = WanColors.theme,
                        disabledContainerColor = WanColors.orange,
                        disabledContentColor = WanColors.orange,
                    )
                ) {
                    Column(
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = WanColors.orange,

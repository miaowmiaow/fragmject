...
import com.example.fragmject.core.network.utils.CacheUtils.getTotalSize
...
fun SettingScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collect { event ->
            when (event) {
                SettingEvent.LogoutCompleted -> onNavigateUp()
            }
        }
    }
                ...
                Column(
                    ...
                    if (uiState.user != null) {
                        Button(
                            ...
                            border = BorderStroke(1.dp, WanColors.theme),

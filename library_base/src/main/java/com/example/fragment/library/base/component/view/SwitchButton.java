...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        shadowEffect = true;
        uncheckCircleColor = 0XffAAAAAA;//0XffAAAAAA;
        uncheckCircleWidth = dp2pxInt(1.5f);//dp2pxInt(1.5f);
        uncheckCircleOffsetX = dp2px(10);
        uncheckCircleRadius = dp2px(4);//dp2px(4);
        checkedLineOffsetX = dp2px(4);
        checkedLineOffsetY = dp2px(4);
        shadowRadius = dp2pxInt(2.5f);//dp2pxInt(2.5f);
        shadowOffset = dp2pxInt(1.5f);//dp2pxInt(1.5f);
        shadowColor = 0X33000000;//0X33000000;
